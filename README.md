...
- Quickly add hyperlinks into SuperMemo HTML components.
...
Either:
- Press the assigned hotkey to bring up the hyperlink insertion dialog.
- Open Dev Context Menu and click the `Insert Hyperlink` menu item.
